...
public class CursoDAO {
    private String SELECT_ALL = "SELECT c.idcurso, c.nome_curso, c.descricao, c.data_inicio, c.data_fim, t.tipo_curso c.preco  FROM curso c INNER JOIN tipo_curso t ON t.pk_tipo_curso = c.idcurso";
    private String INSERT = "INSERT INTO curso (`nome_curso`,`descricao`,`data_inicio`,`data_fim`,`tipo_curso`,`preco`) VALUES(?, ?, ?, ?, ?, ?)";
    private String EDITE= "UPDATE curso SET nome_curso = ?, descricao = ?, data_inicio = ?, data_fim = ?, tipo_curso = ?, preco = ? WHERE idcurso = ?";
    private String DELETE = "DELETE FROM curso WHERE idcurso = ?;";
    private String LIST_BY_NAME="SELECT c.idcurso, c.descricao, c.nome_curso, c.data_inicio, c.data_fim, t.tipo_curso, c.preco FROM curso c INNER JOIN tipo_curso t ON t.pk_tipo_curso = t.pk_tipo_curso WHERE c.nome_curso LIKE ?";
    private String INSERTE = "INSERT INTO `curso` (`nome_curso`,`descricao`,`data_inicio`,`data_fim`,`tipo_curso`,`preco`) VALUES ( ?, ?, ?, ?, ?, ?);";
